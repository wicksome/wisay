...
public class TabAllListActivity extends Activity {
	private BackPressCloseHandler backPressCloseHandler;
	private ArrayList<Item> allDataList;

	// tab_allList
	private ListView sayingListView;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		itemDialog = (View) View.inflate(TabAllListActivity.this,
	...
	private void tabAllList() {
		dataContorl = new ItemContorl(getApplicationContext());
		allDataList = new ArrayList<Item>(dataContorl.getAllData());

		m_adapter = new ItemAdapter(this, R.layout.listview_item, allDataList);
		...
		sayingListView
				.setOnItemClickListener(new AdapterView.OnItemClickListener() {
					...
					public void onItemClick(AdapterView<?> arg0, View arg1,
							int arg2, long arg3) {
						clickItem = new Item();
						clickItem = allDataList.get(arg2);
